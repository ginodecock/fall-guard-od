...
stedgeai generate --no-inputs-allocation --no-outputs-allocation --model st_yolo_x_nano_256_0.5_0.4_int8.tflite --target stm32n6 --st-neural-art default@user_neuralart.json
