...
stedgeai generate --no-inputs-allocation --no-outputs-allocation --model st_yolo_x_nano_192_0.33_0.25_int8.tflite --target stm32n6 --st-neural-art default@user_neuralart.json
