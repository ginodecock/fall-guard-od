...
stedgeai generate --no-inputs-allocation --no-outputs-allocation --model yolov8n_256_quant_pc_uf_od_coco-person.tflite --target stm32n6 --st-neural-art default@user_neuralart.json
