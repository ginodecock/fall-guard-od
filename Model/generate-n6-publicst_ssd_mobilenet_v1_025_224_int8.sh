...
stedgeai generate --no-inputs-allocation --no-outputs-allocation --model st_ssd_mobilenet_v1_025_224_int8.tflite --target stm32n6 --st-neural-art default@user_neuralart.json
