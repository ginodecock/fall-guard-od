...
stedgeai generate --no-inputs-allocation --no-outputs-allocation --model quantized_model_ssd_mobilenet_v2_fpnlite.tflite --target stm32n6 --st-neural-art default@user_neuralart.json
