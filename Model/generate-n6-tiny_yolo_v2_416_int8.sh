...
stedgeai generate --no-inputs-allocation --no-outputs-allocation --model tiny_yolo_v2_416_int8.tflite --target stm32n6 --st-neural-art default@user_neuralart.json
