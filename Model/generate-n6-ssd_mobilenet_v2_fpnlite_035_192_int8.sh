...
stedgeai generate --no-inputs-allocation --no-outputs-allocation --model ssd_mobilenet_v2_fpnlite_035_192_int8.tflite --target stm32n6 --st-neural-art default@user_neuralart.json
